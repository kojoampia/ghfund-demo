...
import com.ghfund.appdemo.domain.Project;
import com.ghfund.appdemo.repository.ProjectRepository;
...
/**
 * Service Implementation for managing {@link com.ghfund.appdemo.domain.Project}.
 */
@Service
@Transactional
    ...
    public Optional<Project> partialUpdate(Project project) {
        ...
        return projectRepository
            ...
            .map(existingProject -> {
                ...
                if (project.getCurrentRaised() != null) {
                    existingProject.setCurrentRaised(project.getCurrentRaised());
                }
                if (project.getImpactScore() != null) {
                    existingProject.setImpactScore(project.getImpactScore());
                }
